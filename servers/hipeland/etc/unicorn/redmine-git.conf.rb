require '/etc/roxconf/uniconf.d/support'
...
pid File.join(thin.pid_dir, 'unicorn.pid')
stderr_path File.join(thin.log_dir, 'unicorn.stderr.log')
stdout_path File.join(thin.log_dir, 'unicorn.stdout.log')
